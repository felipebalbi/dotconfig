...
* Always ask confirmation before exitting emacs
...
#+BEGIN_SRC emacs-lisp
  ...
  (setenv "no_proxy" "jira01.devtools.intel.com")

#+END_SRC

* JIRA configuration
#+BEGIN_SRC emacs-lisp
  (setq jiralib-url "https://jira01.devtools.intel.com")
#+END_SRC
* User Information
...
Enable ODT Export for =org-mode=
  ...
  (setq message-kill-buffer-on-exit t
        ...
        (quote
         ((:name "unread" :query "tag:unread" :sort-order newest-first)
          ...
          (:name "intel/eywa" :query "tag:eywa and tag:unread" :sort-order newest-first)
          (:name "intel/kernel" :query "tag:kernel and tag:unread" :sort-order newest-first)
          (:name "intel/linux-usb" :query "tag:intel-linux-usb and tag:unread" :sort-order newest-first)
          ...
          (:name "USING-MY-WRONG-EMAIL" :query "(to:balbi@ti.com or cc:balbi@ti.com) and tag:unread")
          ...
          (:name "trace_export" :query "tag:trace_export and tag:unread")
...
* Ledger Mode
#+BEGIN_SRC emacs-lisp
  (add-to-list 'load-path "~/workspace/ledger-mode/")

  (require 'ledger-mode)

  (add-to-list 'auto-mode-alist '("\\.ledger\\'" . ledger-mode))
  (add-to-list 'ledger-environment-alist '("decimal-comma" . t))

  (setq ledger-clear-whole-transactions t
        ledger-reconcile-default-commodity "€"
        ledger-reconcile-force-window-bottom t
        ledger-master-file "/home/balbi/workspace/accounting/general.ledger"
        ledger-reports
        (quote
...
#+END_SRC
* Powerline
Yup, =powerline= is really cool and I'm using it on zsh and emacs.
