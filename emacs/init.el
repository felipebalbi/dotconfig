 ...
 '(notmuch-saved-searches
   (quote
    ((:name "inbox" :query "tag:inbox" :key "i" :sort-order newest-first)
     ...
     (:name "lkml" :query "(to:linux-kernel@vger.kernel.org or cc:linux-kernel@vger.kernel.org) and tag:unread" :sort-order newest-first)
     (:name "to-me" :query "(to:balbi@ti.com or to:balbi@kernel.org) and tag:unread" :sort-order newest-first))))
 '(ruby-indent-level 2)
